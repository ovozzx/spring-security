...
public class SecurityAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		// 사용자가 보내준 비밀번호
		String password = authentication.getCredentials().toString(); // 패스워드인데 왜 객체로 보내주는지 : 비밀번호만 있는 게 아님 지문 등..
		...
		// 그렇지 않으면 예외를 던짐
		throw new BadCredentialsException("아이디 또는 비밀번호가 일치하지 않습니다."); // 부모가 AuthenticationException
	}
